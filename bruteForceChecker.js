     ...
     $.fn.extend({  
         pwdstr: function(el) {			
			return this.each(function() {
					...
					var chars = 0;
                    var rate = 2800000000; // 2011, commerical products can
                    // test up to 2.8 billion passwords/s
                    
                    // test = abc
                    // chars = 78
                    // pos = 78^3 = 474,552
                    // s = 474552/2800000000 = 0.000169482857
                    
                    // computer tests all 26 characters, 10 digits, 32 special characters per iteration
